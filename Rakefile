...
task "db:populate" do
  ...
  Memory.create!(traveller_id: 1,city: "Vancouver",comment: "Walking in Lynn canyon felt like I was in a land forgotten by time.", category: "nature", photo_url: "./img/city/vancouver.jpg", latitude: 49.339074, longitude: -123.018063)
  Memory.create!(traveller_id: 1,city: "Vancouver",comment: "The view from the float plane was incredible!", category: "view", photo_url: "./img/city/vancouver.jpg", latitude: 49.2890192, longitude: -123.1239276)
  ...
  Memory.create!(traveller_id: 2,city: "Paris",comment: "Magical memories created with my children riding this carousel.", category: "activity", photo_url: "./img/city/paris.jpg", latitude: 48.846204, longitude: 2.334198)
  Memory.create!(traveller_id: 2,city: "Paris",comment: "I couldn't believe the traffic around the Arc de Triompe!", category: "landmark", photo_url: "./img/city/paris.jpg", latitude: 48.873792, longitude: 2.295028)
  Memory.create!(traveller_id: 3,city: "Geneva",comment: "The Alps, what a view!", category: "view", photo_url: "./img/city/paris.jpg", latitude: 46.203105, longitude: 6.14308)
  Memory.create!(traveller_id: 3,city: "Geneva",comment: "This etching is such an amazing feat of engineering!", category: "landmark", photo_url: "./img/city/paris.jpg", latitude: 46.2050295, longitude: 6.1440885)
end
